from connect import atualizarPessoa, buscarPorCPF, count, deletarPessoa, inserir, mostrarTodos
...
def index():
    ...
    return render_template("index.html", result=result, total=total_cadastrado)
